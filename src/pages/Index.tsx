...
<header className="fixed top-0 inset-x-0 z-50 bg-background/95 backdrop-blur-md border-b border-border/40">
  ...
  <div className="container flex items-center justify-between h-20 px-4">
    ...
    {/* Brand Logo Linked to Home Route */}
    ...
    {/* Desktop Nav - Clean paths routing directly to standalone pages */}
    ...
    <div className="flex items-center gap-4">
      ...
      {/* Consultation Action Element Container */}
  ...
  {/* Mobile Dropdown Menu Framework with Clean Route Parsing */}
...
<section id="destinations" className="py-1 bg-white">
  ...
  <div className="container px-4 mx-auto">
    ...
    <div className="mb-16">
      ...
      <p className="text-red-600 font-bold uppercase tracking-widest text-sm mb-2">Countries</p>

      <h2 className="text-5xl font-extrabold text-[#0a1128] mb-6">

        Study in the world's <span className="text-red-600 italic">finest</span> cities.

      </h2>

      <p className="text-gray-600 max-w-2xl text-lg">

        We have established partnerships with top-ranked universities across eight chosen countries.
 ...
 const destinations = [

  {
    ...
    "Deadlines": "July",
      ...
      "Requirements": "1. Matric + Inter degree (60%)\n2. Birth Certificate\n3. FRC\n4. Medical Certificate (5000 Rs)\n5. Police Character Certificate\n6. Bank Statement (25-30 Lac, March/May startup)\n7. Maintenance Letter\n8. 4-year Gap Acceptable\n9. IELTS 6 or PTE 58",

      // "Bank Statement": "25-30 Lac (March/May)",

      "Expenses": "1. Consultancy Fee: €300\n2. Documents Attestation: 1 Lac\n3. Acceptance Letter: €200\n4. University Fee: €200 - €1000\n5. Embassy Fee: €50 (Prep: €30)\n6. Appointment: 3 Lac\n7. Show Money: €6000\n8. Visa Arrival: €300\n9. Health Insurance: 15000 Rs\n10. Accommodation: €250 - €1000"
...

   {
    ...
    fullData: {
        ...
        "Requirements": 
            ...
            "1. Personal & Application Documents: Visa Application form, Interview form, Valid Passport (color copy 1st 2 pages on A4 Paper), Student & Sponsor CNIC, FRC (Family Registration certificate), Travel History form, 5x6 cm White Background Photo (professional).\n" +

            "2. Academic: University Offer Letter, Acceptance Letter from University, Original & Attested Educational Documents/Transcripts, Attested photocopies of all educational documents, Cover Letter/SOP (Statement of Purpose).\n" +

            "3. Financial: Affidavit of  financial Support  from sponsor( notary attested), Sponsor Proof of Income (Business Docs OR Salary Slips), 2-year Tax Returns, NTN & Tax Certificates (Student & Sponsor), Tax Certificates of Both Student & Sponsor, Bank Statement (Recent 6 Months Recommended), Account Maintenance Certificate / Letter from Bank,Updated Account Statement.\n" +

            "4. Tuition Fee: Original SWIFT Transfer Receipt (Issued by the Bank).\n" +

            "5. Travel & Accommodation Documents: One-Way Flight Reservation, Hotel/Accommodation Booking, Travel Health Insurance .\n" ,
 ...
 name: "Cyprus",
  ...
  fullData: {
    ...
    "Requirements": 
      ...
      "1. Academic: Matric, Intermediate, Bachelor (Above 50% marks)\n" +

      "2. For Degree Program: IELTS 5 Bands, PTE 58 Scores\n" +

      "3. For Foundation Year: IELTS 4 Bands, PTE (43 to 57) scores\n" +

      "4. Foundation Duration: 3 months\n" +

      "5. Gap: After inter 10 years\n" +

      "6. Document Attestation: Matric/Inter docs must be attested from Board + IBCC + MOFA + Apostille",

    "Expenses": 

      "1. Consultancy Fee: 1 Lac\n" +

      "2. Other Fee: 230,000\n" +

      "3. Regular Case: Fee + 3 Lac",

    "Colleges": "American College, Larnaca College, Mesoyios College, Limassol, Unclean, Philips University, Ledra College, City Unity, CIM, Casa College, Inter College, and others different Lendra colleges."
...

  {
    ...
    fullData: {
      ...
      "1. Matric degree + result card original\n" +

      "2. Intermediate degree + result card original \n" +

      "3. Birth certificate\n" +

      "4. Family Registration Certificate (FRC)\n" +

      "5. Medical certificate 5000 Rs\n" +

      "6. Police Character Certificate (visa processing time)\n" +

      "7. Bank statement (20 Lac)\n" +

      "8. Maintenance letter\n" +

      "9. 60% Marks compulsory in intermediate\n" +

      "10. 4 year Gap Acceptable\n" +

      "11. IELTS 5.5 or PTE 58 \n" ,

      "Expenses": 

      "1. Consultancy fee: €500\n" +

      "2. Documents Attestations: 1 Lac\n" +

      "3. Acceptance letter: €200\n" +

      "4. University Fee: €3000 to €3500 (per year)\n" +

      "5. Visa: Bank statement 20 Lac (for two months)\n" +

      "6. Embassy Interview: 45000 (Interview preparation: 25k)\n" +
      ...
      "1. Petroleum and gas uni of Poliesti (€150) | Dates: 1st March to 15 July\n" +

      "2. Politechnica Uni of Bucharest | Status: Admission accepted, acceptance awaiting\n" +

      "3. Technical Uni of Cluj Napoca | Status: Application in process, Fee: €100\n" +

      "4. Babes Bolyai uni | Admission: 13 July-30 July & 7 Sep-16 Sep | Program: Engineering Physics\n" +

      "5. Ovidius Uni of Constanta | Fee: €200 | Admission: Open since 20 April\n" +

      "6. Alexandru Ioan Cuza University of Iasi\n" +

      "7. Uni of Bucharest | Admission fee: €100\n" +

      "8. Gheorghe Asachi Technical Uni of Iasi | Dates: 15 April to 15 July | Fee: €80"
  ...
  { name: "United Kingdom", code: "gb", image:"uk.jpg", tag: "Top Rankings", fullData: null },

  { name: "Malaysia", code: "my", image:"mly.jpg",tag: "Affordable", fullData: null },

  { name: "Ireland", code: "ie", image:"ireland.jpg",tag: "Tech Hub", fullData: null },

  { name: "South Korea", code: "kr", image:"south-korea.jpg", tag: "Modern", fullData: null }
  ...
  <div className="container px-4 mx-auto">
    ...
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
     ...
     {destinations.map((d, i) => (
        ...
        <div key={i} onClick={() => setSelectedDestination(d)} className="cursor-pointer bg-[#0a1128] text-white p-8 rounded-2xl flex flex-col items-center hover:bg-[#0f1a3a] transition-all">

          <img src={`https://flagcdn.com/w320/${d.code}.png`} className="w-20 h-14 mb-4 rounded shadow-md" />

    <h3 className="text-xl font-bold mb-4">{d.name}</h3>

    <div className="flex flex-col items-center gap-2 mt-auto">

      <p className="text-sm text-gray-400 mt-2 text-center">{d.tag}</p>
  ...
  {selectedDestination && (
    ...
    <div className="fixed inset-0 z-[1000] flex items-center justify-center bg-black/60 p-4">
      ...
      <div className="bg-white w-full max-w-4xl rounded-3xl p-8 relative shadow-2xl flex flex-col md:flex-row gap-8 max-h-[90vh]">

        <button 

  onClick={() => setSelectedDestination(null)} 

  className="absolute top-2 right-2 p-2 text-gray-500 hover:text-black z-50"
...
>
  ...
  ✕
        ...
        <div className="md:w-1/2 overflow-y-auto pr-2 custom-scrollbar">
          ...
          <h2 className="text-4xl font-bold text-[#0a1128] mb-1">{selectedDestination.name}</h2>

          <p className="text-red-600 font-semibold italic mb-6">{selectedDestination.tag}</p>

          

          <div className="space-y-6">

            {selectedDestination.fullData ? (

              Object.entries(selectedDestination.fullData).map(([key, value]) => (

                <div key={key}>

                  <strong className="block text-[11px] uppercase text-gray-400 tracking-widest mb-1">{key}</strong>
  ...
  {typeof value === 'object' ? JSON.stringify(value) : String(value)}
              ...
              <p className="text-gray-400 italic">Detailed information coming soon...</p>
        ...
        <div className="md:w-1/2 flex flex-col gap-6">
          ...
          {selectedDestination.image ? (
            ...
            <img src={selectedDestination.image} className="rounded-2xl w-full h-64 object-cover shadow-lg" />

          ) : (

            <div className="w-full h-64 bg-gray-200 rounded-2xl flex items-center justify-center text-gray-400">No Image</div>

          )}

          <div className="bg-[#0a1128] p-6 rounded-2xl text-white text-center">

            <p className="text-sm opacity-80 mb-4">Interested in {selectedDestination.name}?</p>
  ...
  className="w-full bg-white text-[#0a1128] py-4 rounded-xl font-bold text-center block hover:bg-gray-100 transition-all"
